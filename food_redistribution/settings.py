...
SECRET_KEY = 'django-insecure-1dl7ek8yjus*b-03c28+z0zh4t-em)im#am^xx2f*rbj1-el12'
...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'static'),  # This points to the project-level static folder
]
